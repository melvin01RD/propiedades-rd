...
class Property(Base):
    ...
    currency: Mapped[Currency] = mapped_column(SAEnum(Currency), default=Currency.USD, nullable=False)
    ...
    status: Mapped[PropertyStatus] = mapped_column(SAEnum(PropertyStatus), default=PropertyStatus.draft, nullable=False)
